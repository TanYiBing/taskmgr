...
export function reducer(state: State = initialState, action: actions.Actions | prjActions.ProjectActions): State {
  switch (action.type) {
    ...
    case prjActions.ProjectActionTypes.DELETE_SUCCESS:
      return { ...delListByPrj(state, <prjActions.DeleteSuccessAction>action) };
    default:
      return state;
  }
}
